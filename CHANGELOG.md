...
- Dependencies: Update arrow from 59.1.0 to 59.3.0 ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
- Dependencies: Update arrow-array from 59.1.0 to 59.3.0 ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
...
- Dependencies: Update futures from 0.3.32 to 0.3.34 ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
- Dependencies: Update futures-util from 0.3.32 to 0.3.34 ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
- Dependencies: Update jiff from 0.2.32 to 0.2.35 ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
...
- Dependencies: Update serde_with from 3.21.0 to 3.22.0 ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
...
- [RUSTSEC-2026-0204]: Update crossbeam-epoch from 0.9.18 to 0.9.20 ([@dirksammel](https://github.com/dirksammel))
...
- AUDITOR: Stop archival if the file already exists and fix archival integration test ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
...
- Archival: Zero padding archive filenames ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
...
- Dependencies: Update jiff from 0.2.23 to 0.2.32 ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
...
- Dependencies: Update parquet from 58.0.0 to 59.1.0 ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
...
- Dependencies: Update pyo3-async-runtimes from 0.27.0 to 0.29.0 ([@dirksammel](https://github.com/dirksammel))
- Dependencies: Update pyarrow from 21.0.0 to 23.0.1 ([@dirksammel](https://github.com/dirksammel))
...
- Dependencies: Update regex from 1.12.3 to 1.13.0 ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
...
- Dependencies: Update unicode-segmentation from 1.12.0 to 1.13.3 ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
...
- [CVE-2026-31812]: Update quinn-proto from 0.11.13 to 0.11.14 ([@dirksammel](https://github.com/dirksammel))
- [CWE-201, CWE-823]: Update lz4_flex from 0.12.0 to 0.12.1 ([@dirksammel](https://github.com/dirksammel))
- [CWE-299]: Update rustls-webpki from 0.103.7 to 0.103.10 ([@dirksammel](https://github.com/dirksammel))
...
- HTCondor collector: Add CompletionDate to query ([@dirksammel](https://github.com/dirksammel))
...
- Dependencies: Update actions/download-artifact from 6 to 8 ([@dirksammel](https://github.com/dirksammel))
- Dependencies: Update actions/upload-artifact from 5 to 7 ([@dirksammel](https://github.com/dirksammel))
- Dependencies: Update actix-tls from 3.4.0 to 3.5.0 ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
...
- Dependencies: Update config from 0.15.18 to 0.15.22 ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
- Dependencies: Update crate-ci/typos from 1.38.1 to 1.44.0 ([@dirksammel](https://github.com/dirksammel))
- Dependencies: Update criterion from 0.7.0 to 0.8.2 ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
...
- Dependencies: Update fake from 4.4.0 to 5.1.0 ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
...
- Dependencies: Update nick-fields/retry from 3 to 4 ([@dirksammel](https://github.com/dirksammel))
- Dependencies: Update once_cell-1.21.4 ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
...
- Dependencies: Update quickcheck from 1.0.3 to 1.1.0 ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
- Dependencies: Update quickcheck_macros from 1.1.0 to 1.2.0 ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
- Dependencies: Update rand from 0.9.2 to 0.10.0 ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
- Dependencies; Update rand_distr from 0.5.1 to 0.6.0 ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
...
- Dependencies: Update ruff from 0.14.2 to 0.15.7 ([@dirksammel](https://github.com/dirksammel))
...
- Dependencies: Update tokio from 1.48.0 to 1.50.0 ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
...
- Dependencies: Update actions/download-artifact from 4 to 6 ([@dirksammel](https://github.com/dirksammel))
- Dependencies: Update actions/setup-python from 5 to 6 ([@dirksammel](https://github.com/dirksammel))
- Dependencies: Update actions/upload-artifact from 4 to 5 ([@dirksammel](https://github.com/dirksammel))
- Dependencies: Update ad-m/github-push-action from 0.8.0 to 1.0.0 ([@dirksammel](https://github.com/dirksammel))
- Dependencies: Update anyhow from 1.0.98 to 1.0.100 ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
...
- Dependencies: Update parquet from 56.0.0 to 57.0.0 ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
...
- Dependencies: Update rand from 0.8.5 to 0.9.2 ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
- Dependencies: Update rand_distr from 0.4.3 to 0.5.1 ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
...
- Dependencies: Update pydantic from 2.10.6 to 2.11.3 ([@dirksammel](https://github.com/dirksammel))
- Dependencies: Update pytest-cov from 6.0.0 to 6.1.1 ([@dirksammel](https://github.com/dirksammel))
